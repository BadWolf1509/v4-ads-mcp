...
>
> **Last updated:** 2026-05-25 (Sprint M.2a signoff — +2 findings novos: **F47** (PowerShell pipe CRLF mangling em secret creation), **A6** (Meta OAuth callback `is_allowed_email` design error — contas FB são pessoais). 44 unique findings (F1-F47 + A1-A6, alguns IDs skipped).)
...
| Status | Count |
|---|---|
| **Fixed** (source code change) | 29 (added F46, F48, F49 — M.2b smoke real) |
...
**Total findings tracked:** 46 (was 41 + F46/F47/F48/F49 + A6).
