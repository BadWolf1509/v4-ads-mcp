...
@register_tool(
    ...
    description=(
        "[DEFER] Prefira get_performance_breakdown(level=ad) — este report sera arquivado "
        "(Fase 2B). Performance por anuncio (RSA) com headlines, descriptions, final_urls e "
