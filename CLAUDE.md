...
- **Meta App Review submit** (Wellington manual fora-MCP, ~2h prep + 5-30d Meta timeline): após smoke 8/8 PASS + screencast 3-5 min + 3 scope justifications. **Decision gate pós-M.2b:** 2 semanas dogfood Wellington — ≥3 usos/semana = continua M.3-M.25; senão pause + foca Google backlog.
