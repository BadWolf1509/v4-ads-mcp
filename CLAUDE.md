...
- **Phase 3b restante** — Sprints 3b.24, 3b.25, 3b.26 shipados em produção (49 MCP tools). 2 sprints faltantes pra finalizar roadmap V4:
  - **Sprint 3b.27** candidate — `upload_customer_match_list` + A4 investigation (audience exclusion mechanism aberto desde Sprint 3b.4/3b.5; LGPD-heavy: SHA-256 hashing client-side; ver [findings-catalog.md](docs/operacao/findings-catalog.md) §A4)
  - **Sprint 3b.28** candidate — `remove_keyword/campaign/ad_group/ad/asset` bundle (cleanup ops + cleanup de ~75 entities criadas em Nutry sandbox durante smokes 3b.24-3b.26)
