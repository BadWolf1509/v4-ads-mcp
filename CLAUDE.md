...
**68 MCP tools** (62 Google + 6 Meta), CI gated + deploy automático. Catálogo até **F187**. **Detalhe, pendências e decision gates vivem em
...
[`findings-catalog.md`](docs/operacao/findings-catalog.md) pela área ou sintoma — **F1–F187, ~4290 linhas, 471 KB**. Grep por palavra-chave (`GAQL`, `pool`, `Meta`, `audit`, `CSP`); ler
