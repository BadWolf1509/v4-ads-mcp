...
[`findings-catalog.md`](docs/operacao/findings-catalog.md) pela área ou sintoma — **F1–F187, ~4430 linhas, 475 KB**. Grep por palavra-chave (`GAQL`, `pool`, `Meta`, `audit`, `CSP`); ler
