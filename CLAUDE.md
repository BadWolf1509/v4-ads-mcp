...
**Decision gates:** **checkpoint volume Meta** (janela 06-25→07-10; 500 calls/15d → re-submit Full Access) — volume real 07-02 = **só 43 calls, 2,3% erro** → longe de 500; M.5 alimentaria OU estender · **soak Fase 2A→2B** → NÃO tombstonar (ver "Próximo sprint" acima) · ~~2026-07-25 reconectar Meta OAuth Wellington~~ — **feito em 11/08**, válido até 10/10/2026 (era opcional de todo jeito: Modelo B cobre).
